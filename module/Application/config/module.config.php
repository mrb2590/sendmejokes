...
return array(
    ...
    'view_manager' => array(
        'display_not_found_reason' => (isset($_SERVER['APPLICATION_ENV']) && $_SERVER['APPLICATION_ENV'] == 'development') ? true : false,
        'display_exceptions'       => (isset($_SERVER['APPLICATION_ENV']) && $_SERVER['APPLICATION_ENV'] == 'development') ? true : false,
        'doctype'                  => 'HTML5',
    ...
    'console' => array(
        'router' => array(
            'routes' => array(
                'email-daily-joke' => array(
                    'options' => array(
                        'route'    => 'emaildailyjoke (--user|-u|--all|-a) [<userEmail>]',
                        'defaults' => array(
                            'controller' => 'Application\Controller\Console',
                            'action'     => 'email-daily-joke'
                        )
                    )
                )
            ),
